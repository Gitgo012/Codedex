...
todo=['Get quarters', 'Do laundry','Take a walk','Get a haircut', 'Make some tea', 'Complete list chapter', 'Call mom', 'Watch My Hero Academia']
#print the first and last index item
print(todo[0])
print(todo[-1])
#do slicing
print(todo[1:5])
